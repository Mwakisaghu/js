...
const productList = {
  products: [
    ...
    new Product('A Carpet', 'https://ke.jumia.is/unsafe/fit-in/500x500/filters:fill(white)/product/95/994803/1.jpg?7448', 89.99, 'A clean and nice carpet which you might like!')
    /*{
      title: 'A Carpet',
      imageUrl:
